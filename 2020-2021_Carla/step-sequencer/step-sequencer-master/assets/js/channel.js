...
(function (App, document) {
  ...
  App.Channel = function (initSampleUrl) {
    ...
    function setMostRecentAudioInstance(audioInstance) {
      ...
      audioInstances.splice(audioInstances.indexOf(audioInstance), 1);
    ...
    function refreshPlayers(which) {
      var i,
        audioInstance,
        updatePolyphony =
          (typeof which === "object" && which.polyphony) || true,
