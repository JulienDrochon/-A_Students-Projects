...
(function (App, $) {
  ...
  App.ui.Transport = function (containerSelector) {
    ...
    function pausedOrStopped() {
      $playPauseButton
        .addClass("play icon-play")
        .removeClass("pause icon-pause");
    }
    ...
    $timeSigBeatsPerMeasure.change(function () {
      events.trigger("ui.transport.timesignature.change", [
        parseInt($(this).val(), 10),
        parseInt($timeSigBeatLength.val(), 10),
      ]);
    });
    ...
    $timeSigBeatLength.change(function () {
      events.trigger("ui.transport.timesignature.change", [
        parseInt($timeSigBeatsPerMeasure.val(), 10),
        parseInt($(this).val(), 10),
      ]);
    });
